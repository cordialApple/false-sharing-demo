...
| basic/tp_h3_adjacent_atomics | H3 (atomic_pair) | H3 %struct.atomic_pair | PASS |
| basic/tp_h5_adjacent_globals | H5 | H5 @counter_a, @counter_b | PASS |

## Summary

- **Unexpected FP** (false alarms on TN cases): 0
- **Unexpected FN / MISS** (TP cases not caught): 0
- **Known Gaps** (known_limitation=true, not penalized): 2
