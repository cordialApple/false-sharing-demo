#!/bin/sh
# FETCH HURON SUITE. COMPILE 7 C PROGRAM TO IR. SAME FLAGS AS CORPUS.
...
# CLONE ONCE. SHALLOW. HURON REPO BIG, ONLY WANT test_suites.
if [ ! -d "$HURON" ]; then
...
# STRING_MATCH OLD CODE. CALL gettimeofday WITH NO INCLUDE. FORCE HEADER.
